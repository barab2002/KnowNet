...
export const RichTextEditor: React.FC<RichTextEditorProps> = ({
  ...
  return (
    <div className={`tiptap-editor flex flex-col rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden bg-slate-50 dark:bg-[#233648]/50 focus-within:ring-2 focus-within:ring-primary/20 transition-all ${className}`}>
      {/* ── Toolbar ── */}
