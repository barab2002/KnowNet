  ...
  return (
    <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-display min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-12 gap-6">
        ...
        <aside className="col-span-3 hidden lg:block sticky top-24 h-fit space-y-2">
          <nav className="space-y-1">
            <a className="flex items-center gap-3 px-4 py-3 bg-primary/10 text-primary font-semibold rounded-xl" href="#">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-card-dark border-t border-slate-200 dark:border-slate-800 px-6 py-3 flex justify-between items-center z-50">
        <button className="text-primary"><span className="material-icons-round">home</span></button>
        <button className="text-slate-400"><span className="material-icons-round">explore</span></button>
        ...
        <button className="text-slate-400"><span className="material-icons-round">collections_bookmark</span></button>
        <button className="text-slate-400"><span className="material-icons-round">person</span></button>
      </nav>
    </div>
  );
};
